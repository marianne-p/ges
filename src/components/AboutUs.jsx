            ...
            <div className="flex flex-col md:flex-row gap-8 mt-4 text-lg">
              ...
              <div className="w-full md:w-[60%] text-left">
                <p className="text-gray-600 mb-4">
                  Have you ever wondered why more organisations aren't using solar? So did we - and then we understood. You need to become a solar expert instead of focussing on your own activities, and invest thousands of pounds of capital (or borrow money at high interest rates) to do so. Alternatively, you sign a highly complex power purchase agreement (PPA) and hand over your roof/land to a mini energy company who sells you the energy a bit cheaper than the grid. If we had to make a choice, we wouldn't choose either.
                </p>
                <p className="text-gray-600 mb-4">
                  That's how Green Earth Solutions and our innovative solar service were born. Our aim is to help more organisations benefit from solar installations – and we really mean benefit. We believe that a solar installation which is professionally monitored and maintained can create lots of value. We want to unlock this for organisations without the need for them to become solar experts – that's our role. We combine expertise from commercial strategy, finance and solar operations to bring a better option to organisations interested in solar.
                </p>
